# National Dex skeleton (Gen 1–9): [dex, species name, "Type" or "Type/Type"].
# Current typings. #1–649 hand-validated; #650–1025 generated from PokeAPI. Do not hand-edit lightly.
POKEDEX = [
...
GEN_RANGES = [(1,1,151),(2,152,251),(3,252,386),(4,387,493),(5,494,649),
...
def gen_for(num):
    """Generation (1–9) for a National Dex number, or None."""
    for g, lo, hi in GEN_RANGES:
        if lo <= num <= hi:
            return g
    return None
